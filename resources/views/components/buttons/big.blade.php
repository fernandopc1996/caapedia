...
<button
    ...
    x-bind:class="(clicked || {{ $disabled ? 'true' : 'false' }})
        ...
        : 'border rounded shadow hover:bg-gray-200/80 transition duration-300 ease-in-out flex items-center p-2 space-x-3 min-h-20 hover:scale-105 active:scale-95'"
    {{ $attributes }}
>
    {{ $slot }}
</button>
