<div>
    <div class="grid grid-cols-2 justify-between mt-3 gap-4">
        ...
        <div class="flex flex-col items-center gap-1">
            ...
            <x-mary-icon name="fas.frown" :label="App\Helpers\Formatter::formatNumber($player->degration, 1, 3)" class="text-2xl text-red-900" />
        </div>
        <div class="flex flex-col items-center gap-1">
            <span class="text-xs font-semibold">Água útil (m³):</span>
            <x-mary-icon name="fas.tint" :label="App\Helpers\Formatter::formatNumber($player->water, 3, 3)" class="text-2xl text-blue-900" />
        </div>
        <div class="flex flex-col items-center gap-1">
            <span class="text-xs font-semibold">Montante (R$):</span>
            <x-mary-icon name="fas.dollar-sign" :label="App\Helpers\Formatter::formatNumber($player->amount, 2, 5)"
