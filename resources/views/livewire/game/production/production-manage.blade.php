<div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        @foreach ($playerProductions as $item)
    @php
    ...
    >
        <div class="w-full">
            ...
            <p class="text-sm text-gray-600">Construindo</p>
        </div>

        <div class="flex items-center gap-2 w-full mt-2">
            <img src="{{ $character->front_square }}" alt="{{ $character->name }}" class="h-10 w-10 rounded object-cover">
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        const bars = document.querySelectorAll('[data-start][data-end]');
